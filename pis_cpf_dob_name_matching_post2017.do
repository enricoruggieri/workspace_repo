...
use "$PATH/combined_2018.dta", clear
forvalues y = 2019/2020 {
    append using "$PATH/combined_`y'.dta"
}
keep nometrabalhador pis cpf datadenascimento

g name = nometrabalhador
g dob = datadenascimento
keep name pis cpf dob 
duplicates drop
...
save new_workers_post_2017.dta, replace
***************************************************************
use "$PATH/combined_2018.dta", clear
forvalues y = 2019/2020 {
    append using "$PATH/combined_`y'.dta"
...
merge n:n pis using new_workers_post_2017
keep if _merge == 3
drop _merge

save new_workers_post_2017_full.dta, replace
**************************************************************
use new_workers_post_2017_full.dta, clear
...
save "$PATH/all_temp_2018_2020.dta", replace
...
************
use "$PATH/all_temp_2018_2020.dta", clear
...
save pis_cpf_dob_name_matching_2018_2020.dta, replace
